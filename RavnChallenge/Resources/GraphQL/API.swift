  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct AllPerson: GraphQLSelectionSet {
      ...
      public struct Person: GraphQLSelectionSet {
        ...
        public init(id: GraphQLID, name: String? = nil, eyeColor: String? = nil, hairColor: String? = nil, skinColor: String? = nil, birthYear: String? = nil, species: Species? = nil, homeworld: Homeworld? = nil, vehicleConnection: VehicleConnection? = nil) {
          self.init(unsafeResultMap: ["__typename": "Person", "id": id, "name": name, "eyeColor": eyeColor, "hairColor": hairColor, "skinColor": skinColor, "birthYear": birthYear, "species": species.flatMap { (value: Species) -> ResultMap in value.resultMap }, "homeworld": homeworld.flatMap { (value: Homeworld) -> ResultMap in value.resultMap }, "vehicleConnection": vehicleConnection.flatMap { (value: VehicleConnection) -> ResultMap in value.resultMap }])
        }
